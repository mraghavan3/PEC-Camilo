...
class Broadphase {
	public:
		...
		int removeSameFiberCollisions(custom_vector<long long> &potentialCollisions, custom_vector<int> &stencil);
		int removeSameFiberCollisionsH(thrust::host_vector<long long> &potentialCollisions, thrust::host_vector<int> &stencil);
